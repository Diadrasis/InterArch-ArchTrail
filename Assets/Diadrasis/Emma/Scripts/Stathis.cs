...
*/
        ...
        public static void saveImage(byte[] myBytes, string dataFileName, Ext fileExtension)
        {
            string tempPath = getPath_MultiPlatform();
        ...
        public static bool deleteImage(string dataFileName, Ext fileExtension)
        {
            bool success = false;
        ...
        public static bool deleteImage(string dataFileName)
        {
            bool success = false;
        ...
        public static T loadImage<T>(string dataFileName, Ext fileExtension)
        {
            ...
            Texture2D txt2D = new Texture2D(200, 200);
            txt2D.LoadImage(newBytes);

            //Convert to Object
            //object resultValue =  JsonUtility.FromJson<T>(newData);
            return (T)Convert.ChangeType(txt2D, typeof(T));
        }
...
//			return path + "/Documents";
	...
	public class Tools_Load : MonoBehaviour
	{
        ...
        static Texture2D LoadTexture(string FilePath)
        {
            ...
            Methods.Print("image from "+FilePath+" is null", true);
