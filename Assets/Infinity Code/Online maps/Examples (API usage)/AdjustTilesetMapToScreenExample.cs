...
namespace InfinityCode.OnlineMapsExamples
{
    ...
    public class AdjustTilesetMapToScreenExample : MonoBehaviour
    {
        ...
        {
            OnlineMapsTileSetControl.instance.allowCameraControl = true;
            ...
            OnlineMapsTileSetControl.instance.cameraDistance = screenHeight * 0.5f;// 0.9f;

            Invoke("StopCameraControl", 0.15f);
        }

        void StopCameraControl()
        {
            OnlineMapsTileSetControl.instance.allowCameraControl = false;
            CancelInvoke();
        }
